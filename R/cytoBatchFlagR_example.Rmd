...
If your data has a large amount batches, you may want to split the data into multiple plots to improve readability. The batches_per_plot parameter can be used in this cases. batches_per_plot indicates the maximum number of batches to include in each plot. For example, if you have 12 batches and batches_per_plot = 5, then for each marker you will have 3 plots (plot 1: batches 1-5, plot 2: batches 6-10, plot 3: batches 11-12). batches_per_plot = NULL is used if you want to include all batches.
...
The final metric is a clustering-based assessment of dataset. This can be used to check if problematic batches impact downstream cell clusters.
