...
# For biomodal detection,  width_cutoff, sep_peaks, dip_cutoff, and min_peak_height_frac can be changed from the default values
...
# For unimodal thresholds, shoulder_frac can be changed
...
# This can be very slow, you may want to subsample more before proceeding
# Set sampling type
# Set as "fixed", "overall_min", "batch_min", or "none" 
sampling_type <-  "fixed"  
